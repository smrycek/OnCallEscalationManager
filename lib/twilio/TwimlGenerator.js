...
exports.Redirect = function (redirectParams) {
    if (!redirectParams.method)
        redirectParams.method = 'POST';

    var redirectTwiml = '<Redirect method="' + redirectParams.method + '">';
    redirectTwiml += redirectParams.URL;
    sayTwiml += '</Redirect>\n'
    return sayTwiml;
}

exports.Error = function (message) {
    var errorTwiml = this.Start();
    errorTwiml += this.Say(message);
